    ...
    <div className="calc">
      ...
      <div className="calc__topmenu">
        ...
        <div className="calc__topmenu-items">
          <div className="calc__topmenu-item active">
            ...
            <span className="calc__topmenu-text">
              Мойки
              <br /> самообслуживания
            </span>
          </div>
      ...
      <div className="calc__bottommenu">
        ...
        <div className="calc__bottommenu-items">
          <div onClick={() => setStep(1)} className={`calc__bottommenu-item ${step === 1 ? "active" : ""}`}>
          ...
          <div onClick={() => setStep(2)} className={`calc__bottommenu-item ${step === 2 ? "active" : ""}`}>
            <div className="calc__bottommenu-text">
          ...
          <div onClick={() => setStep(3)} className={`calc__bottommenu-item ${step === 3 ? "active" : ""}`}>
            <div className="calc__bottommenu-text">
          ...
          <div onClick={() => setStep(4)} className={`calc__bottommenu-item ${step === 4 ? "active" : ""}`}>
            <div className="calc__bottommenu-text">
          ...
          <div onClick={() => setStep(5)} className={`calc__bottommenu-item ${step === 5 ? "active" : ""}`}>
            <div className="calc__bottommenu-text">
            ...
            <div className="calc__sitebar-posts">
              ...
              <ul className="calc__postitems">
                {posts.map((post: any) => {
                  return (
                    ...
                    >
                      <span className="calc__postitem-round"></span>
                      {post.caption}
                    </li>
                  );
                })}
              ...
              <ul className="calc__postitems">
                {consolePosts.map((post: any) => {
                  return (
                    <li
                      onClick={() => checkConsolePostHandler(post.id - 1)}
                      key={post.id}
                      className={`calc__postitem ${post.check ? "active" : ""}`}
                    >
                      <span className="calc__postitem-box"></span>
                      {post.caption}
                    </li>
                  );
                })}
      ...
      <div className="calc__buttons">
        {step > 1 ? <Button onClickHandle={() => setStep(step - 1)} title="Назад" /> : null}
