			...
			<div className="header__top">
                <div className="header__top-wrapper">
                    ...
                    <ul className="header__top-items">
                        ...
                        <li className="header__top-item">
                            <Link to="/" className="header__top-link">О компании</Link>
                        </li>
                        <li className="header__top-item">
                            <Link to="/" className="header__top-link">Статьи</Link>
                        </li>
                        <li className="header__top-item">
                            <Link to="/" className="header__top-link">Контакты</Link>
                        </li>
                        <li className="header__top-item">
                            <Link to="/" className="header__top-link">Наши работы</Link>
                        </li>
                    </ul>
                </div>
                ...
                <div className="header__text">
                    ...
                    <div className="header__title-wrapper">
                        ...
                        <div className="header__subtitle">
                            Более 1000 работающих объектов!<br/>
